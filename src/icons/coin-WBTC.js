  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_2_99)">
        ...
        ></path>
        <path
          d="M16.16 9.801c-.131-1.375-1.318-1.836-2.818-1.977V5.931h-1.16v1.858h-.927V5.931h-1.15v1.906H7.751V9.08s.856-.016.843 0a.6.6 0 01.66.51v5.218a.407.407 0 01-.141.284.403.403 0 01-.3.1c.016.014-.843 0-.843 0l-.22 1.387h2.331v1.937h1.16v-1.909h.927v1.9h1.162v-1.915c1.96-.119 3.326-.602 3.497-2.436.138-1.476-.556-2.135-1.665-2.401.674-.332 1.092-.947.997-1.953zm-1.625 4.125c0 1.441-2.47 1.277-3.255 1.277v-2.557c.786.002 3.255-.224 3.255 1.28zm-.538-3.602c0 1.318-2.06 1.158-2.715 1.158V9.158c.654 0 2.715-.207 2.715 1.166z"
          fill="#F09242"
        ></path>
        <path
